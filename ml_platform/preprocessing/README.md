...
Person Crop BGR Image → `ml_platform/preprocessing/silhouette_extractor.py` → 64×128 Binary Silhouette Mask → `ml_platform/preprocessing/gei_builder.py` → 64×128 GEI Image.
