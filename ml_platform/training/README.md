...
- Saving trained model weights into candidate checkpoints (`ml_platform/models/model_store/candidates/` / `runs/`).
...
GEI Training Dataset → `ml_platform/training/dataset.py` & `ml_platform/training/dataloader.py` → `ml_platform/models/architectures/bygait_light.py` → `ml_platform/training/loss_functions.py` → `ml_platform/training/trainer.py` → `ml_platform/models/model_store/candidates/best_model.pth`.
