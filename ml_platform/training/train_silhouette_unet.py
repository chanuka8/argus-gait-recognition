...
def train_and_export_silhouette_unet(
    ...
    batch_size: int = 16,
    lr: float = 1e-3,
    output_dir: str = "ml_platform/models/model_store/weights",
) -> dict:
    os.makedirs(output_dir, exist_ok=True)
    os.makedirs("ml_platform/models/model_store/engines", exist_ok=True)
    ...
    onnx_valid, onnx_msg = export_and_validate_onnx(
        ...
        engine_onnx_path="ml_platform/models/model_store/engines/silhouette_segmenter.onnx",
    )
    ...
    summary = {
        ...
        "onnx_engines_path": "ml_platform/models/model_store/engines/silhouette_segmenter.onnx",
        "dice": float(avg_dice),
        "iou": float(avg_iou),
