...
def run_evaluation():
    ...
    extractor = ReIDFeatureExtractionStep(model_path="ml_platform/models/model_store/weights/osnet_x0_25.pth", device=device)
    ...
    OSNetBackbone._instance = None
    extractor2 = ReIDFeatureExtractionStep(model_path="ml_platform/models/model_store/weights/osnet_x0_25.pth", device=device)
    ...
    gait_feat_file = Path("ml_platform/models/galleries/gallery/gallery_features.npy")
