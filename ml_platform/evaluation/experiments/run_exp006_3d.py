...
from ml_platform.evaluation.experiments.evaluate_exp004 import evaluate_checkpoint
from ml_platform.evaluation.gallery_probe_builder import build_gallery_and_probe_sets
from ml_platform.evaluation.metrics import compute_biometric_rates, compute_roc_auc_eer
from ml_platform.models.architectures.pose_gait_3d import PoseGait3DNet, PoseLifter3D
...
def main():
    ...
    yolo_pose = YOLO("ml_platform/models/model_store/weights/yolov8n-pose.pt")
