...
- Housing full-scale biometric benchmarks in `ml_platform/evaluation/benchmarks/`.
- Housing one-off experiment, diagnostic, and audit scripts in `ml_platform/evaluation/experiments/`.
- Persisting evaluation reports, metric records, and generated charts in `ml_platform/evaluation/results/`.
...
Dataset GEIs / Models → `ml_platform/evaluation/evaluator.py` → `ml_platform/evaluation/metrics.py` → `ml_platform/evaluation/visualizer.py` → `outputs/reports/evaluation/`.
