...
from app.core.paths import get_config_path, resolve_app_path, resolve_runtime_path
...
def load_inference_backend_config(config_path: str | Path | None = None) -> dict:
    ...
    defaults = {
        ...
        "engine_path": "ml_platform/models/model_store/engines/bygait_light_fp16.engine",
...
class BackendValidator:
    ...
    def check_onnxruntime(self) -> BackendHealth:
        try:
            ...
            onnx_path = resolve_app_path(self.config.get("onnx_path", "ml_platform/models/model_store/engines/bygait_light.onnx"))
...
class BackendReport:
    ...
    def generate(self) -> dict:
        ...
        if self.backend.active_backend == "onnxruntime":
            raw_p = str(self.backend.config.get("onnx_path", "ml_platform/models/model_store/engines/bygait_light.onnx"))
        else:
