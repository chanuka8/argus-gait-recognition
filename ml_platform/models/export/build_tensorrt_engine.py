...
def main() -> None:
    ...
    parser.add_argument("--onnx-path", type=str, default="ml_platform/models/model_store/engines/bygait_light.onnx", help="Path to ONNX file")
    parser.add_argument(
        "--engine-path", type=str, default="ml_platform/models/model_store/engines/bygait_light_fp16.engine", help="Output engine path"
    )
