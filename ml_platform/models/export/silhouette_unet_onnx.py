...
def export_and_validate_onnx(
    pth_path: str = "ml_platform/models/model_store/weights/silhouette_segmenter.pth",
    output_onnx_path: str = "ml_platform/models/model_store/weights/silhouette_segmenter.onnx",
    engine_onnx_path: str = "ml_platform/models/model_store/engines/silhouette_segmenter.onnx",
) -> tuple[bool, str]:
