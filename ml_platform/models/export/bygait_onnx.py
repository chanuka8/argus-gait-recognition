...
def export_onnx(
    ...
    output_onnx_path: str = "ml_platform/models/model_store/engines/bygait_light.onnx",
    precision: str = "fp32",
    rtol: float = 1e-3,
    atol: float = 1e-4,
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-path", type=str, default="ml_platform/models/model_store/engines/bygait_light.onnx", help="Output ONNX file path"
    )
