...
from app.core.paths import resolve_app_path, resolve_runtime_path
from app.storage.vector_store import validate_gallery_files
from ops.deployment.backend_summary import BackendStartupSummary
from ops.deployment.build_metadata import extract_build_metadata
from ops.deployment.runtime_manifest import get_runtime_manifest
from ops.deployment.shutdown_manager import ShutdownManager
...
def run_deployment_smoke_test(
    ...
    try:
        ...
        g_valid, g_err, _g_count = validate_gallery_files(gallery_dir=resolve_app_path("ml_platform/models/galleries/gallery"), expected_dim=256)
