...
from ml_platform.models.reid.osnet_backbone import _build_osnet_x0_25
...
def run_runtime_validation():
    ...
    ckpt_path = "ml_platform/models/model_store/weights/osnet_x0_25.pth"
    ...
    gait_updater = GalleryUpdater(gallery_dir="ml_platform/models/galleries/gallery")
