...
from app.pipeline.steps.silhouette_step import LearnedSilhouetteSegmenter, OtsuSilhouetteExtractor
...
def benchmark_silhouette_segmenters(
    ...
    learned = LearnedSilhouetteSegmenter(model_path="ml_platform/models/model_store/weights/silhouette_segmenter.onnx")
