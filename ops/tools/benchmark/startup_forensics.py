...
def run_stage_profiling() -> dict:
    ...
    _, timings["init_vector_stores"] = time_block(
        ...
        lambda: (
            VectorStore(gallery_dir="ml_platform/models/galleries/live_gallery"),
            VectorStore(gallery_dir="ml_platform/models/galleries/appearance_gallery"),
        ),
    )
    ...
    _, timings["init_embedding_db"] = time_block(
        ...
        lambda: (
            EmbeddingDatabase(
                gait_gallery_dir="ml_platform/models/galleries/live_gallery",
                appearance_gallery_dir="ml_platform/models/galleries/appearance_gallery",
            ),
            ModelRegistry(),
        ),
    )
    ...
    _, timings["import_app_and_routers"] = time_block(
        ...
        lambda: __import__("app.api.server"),
    )
