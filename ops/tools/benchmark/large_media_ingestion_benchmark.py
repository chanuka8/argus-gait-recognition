...
from app.pipeline.steps import tracking as pipeline_tracking
...
def run_benchmark():
    ...
    orig_track = pipeline_tracking.TrackingStep.track
    ...
    pipeline_tracking.TrackingStep.track = benchmark_mock_track
    temp_video_path.parent.mkdir(parents=True, exist_ok=True)
    ...
    try:
        ...
        pipeline_tracking.TrackingStep.track = orig_track
