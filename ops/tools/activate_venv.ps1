...
.DESCRIPTION
    ...
    the ARGUS AI repository. Designed to be launched via:
        ...
        powershell -NoExit -ExecutionPolicy Bypass -File ops/tools/activate_venv.ps1
...
if (-not (Test-Path -LiteralPath $VenvDir -PathType Container)) {
    ...
    Write-Warning "[ARGUS] Create it with: powershell -File ops/tools/manage_venv.ps1 -Action Recreate"
    return
}
