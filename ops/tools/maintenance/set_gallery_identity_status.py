...
def main() -> None:
    ...
    parser.add_argument(
        "--gallery-dir",
        default="ml_platform/models/galleries/live_gallery",
    )

    args = parser.parse_args()

    if args.gallery_dir == "ml_platform/models/galleries/live_gallery":
        ...
        updated_app = set_status(
            person_id=args.person_id,
            status=args.status,
            gallery_dir="ml_platform/models/galleries/appearance_gallery",
            verbose=False,
        )
