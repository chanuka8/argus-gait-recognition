...
def main() -> int:
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python ops/tools/maintenance/cleanup_python_comments.py --audit
  python ops/tools/maintenance/cleanup_python_comments.py --dry-run
  python ops/tools/maintenance/cleanup_python_comments.py --check
  python ops/tools/maintenance/cleanup_python_comments.py --apply
  python ops/tools/maintenance/cleanup_python_comments.py --path app/api/server.py --dry-run
  python ops/tools/maintenance/cleanup_python_comments.py --self-test
        """,
    )
