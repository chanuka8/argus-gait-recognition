...
from app.core.paths import get_app_root, get_config_path, resolve_app_path, resolve_runtime_path
from app.utils.config_validator import ConfigValidator, sanitize_rtsp_url
from ml_platform.models.inference.backend import BackendValidator, get_inference_backend
...
class DeploymentReadinessReporter:
    ...
    def evaluate_readiness(self) -> dict:
        ...
        onnx_path = resolve_app_path("ml_platform/models/model_store/engines/bygait_light.onnx")
        model_readiness = {
        ...
        gallery_dir = resolve_app_path("ml_platform/models/galleries/gallery")
