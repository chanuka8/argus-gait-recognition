...
from ops.automation.hardware_detector import HardwareDetector, NvidiaGpuInfo
...
class CudaDetector:
    def __init__(self, weights_dir: str | Path = "ml_platform/models/model_store/weights") -> None:
    ...
    def probe_yolo_cuda_execution(self) -> tuple[bool, str, str, str | None]:
        try:
            ...
            if not model_path.exists():
                model_path = resolve_app_path("ml_platform/models/model_store/weights/yolov8n.pt")
    ...
    def probe_onnx_cuda_execution(self) -> tuple[bool, str | None, str, list[str], str | None]:
        ...
        try:
            ...
            model_candidates = [
                ...
                resolve_app_path("ml_platform/models/model_store/weights/silhouette_segmenter.onnx"),
                resolve_app_path("ml_platform/models/model_store/engines/silhouette_segmenter.onnx"),
            ]
