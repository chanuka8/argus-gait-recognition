...
from ops.automation.cuda_detector import CudaDetectionReport, CudaDetector
from ops.automation.hardware_detector import HardwareDetector, HardwareProfile
