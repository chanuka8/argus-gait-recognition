...
- [configs/system.yaml](file:///e:/ARGUS_AI/configs/system.yaml): `logging` and `watchdog` sections

## Public Interfaces

- `CameraMonitor`: Camera health tracker in [monitoring/camera_monitor.py](file:///e:/ARGUS_AI/monitoring/camera_monitor.py).
- `SystemWatchdog`: Watchdog coordinator in [monitoring/watchdog.py](file:///e:/ARGUS_AI/monitoring/watchdog.py).
- `init_logging()`, `get_logger(channel: str)`: Logger initialization in [monitoring/logging_config.py](file:///e:/ARGUS_AI/monitoring/logging_config.py).

## Tests

- [tests/test_logging.py](file:///e:/ARGUS_AI/tests/test_logging.py)
- [tests/test_watchdog.py](file:///e:/ARGUS_AI/tests/test_watchdog.py)
