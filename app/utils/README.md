...
Raw Detection Boxes & Matches → `app/utils/box_stabilizer.py` & `app/utils/prediction_smoother.py` → `app/utils/display_renderer.py` (Screen HUD) & `app/utils/detection_reporter.py` (`outputs/media/detections/`).
