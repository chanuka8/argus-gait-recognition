...
def get_app_root(override: str | Path | None = None) -> Path:
    ...
    4. Deterministic repository/application root derived from app/core/paths.py __file__
    """
    ...
    # Derived deterministically from this file location: <repo_root>/app/core/paths.py -> parents[2]
