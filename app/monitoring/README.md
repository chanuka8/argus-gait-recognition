...
Component Execution → `app/monitoring/logging_config.py` & `app/monitoring/metrics_collector.py` → `app/monitoring/watchdog.py` → `outputs/logs/system/` & `outputs/monitoring/camera_stats/`.
