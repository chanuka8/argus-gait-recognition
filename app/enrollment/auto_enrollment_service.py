...
from app.enrollment.enrollment_lifecycle import EnrollmentLifecycleManager, EnrollmentStatus
...
class AutoEnrollmentService:
    def __init__(
        ...
        video_stride: int = 10,
        scan_interval: int = 5,
        live_gallery_dir: str = "ml_platform/models/galleries/live_gallery",
        appearance_gallery_dir: str = "ml_platform/models/galleries/appearance_gallery",
