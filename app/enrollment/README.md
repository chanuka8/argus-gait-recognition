...
| [gallery_updater.py](gallery_updater.py) | Computes and persists gait GEI feature embeddings into `ml_platform/models/galleries/gallery/` |
<!-- END SYNC: KEY_MODULES -->

## Data Flow

Enrollment Files → `app/enrollment/folder_watcher.py` → `app/enrollment/enrollment_validator.py` → `app/enrollment/gallery_updater.py` → `ml_platform/models/galleries/gallery/` (`.npy` & `.json`).
