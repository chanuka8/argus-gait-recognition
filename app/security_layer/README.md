...
Recognition Match Output → `app/security_layer/security_engine.py` → Security Decision Tier → `app/security_layer/security_logger.py` → `outputs/logs/security/security_events.csv`.
