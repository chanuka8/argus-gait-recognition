...
class ModelVerifier:
    ...
    def __init__(
        ...
        default_manifest_path: str | Path = "ml_platform/models/model_manifest.json",
        default_signature_path: str | Path = "ml_platform/models/model_manifest.sig",
    ...
    def resolve_public_key(
        ...
        default_pub_path = resolve_app_path("app/security_layer/keys/model_signing_pubkey.pem")
