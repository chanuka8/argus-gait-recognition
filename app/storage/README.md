...
Detection Output → `app/storage/evidence_manager.py` → `outputs/media/detections/` (snapshots, GEIs, metadata) & `app/storage/lineage_tracker.py` → `outputs/reports/explainable/lineage.json`.
