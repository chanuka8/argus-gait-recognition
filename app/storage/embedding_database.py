...
class EmbeddingDatabase:
    def __init__(
        ...
        gait_gallery_dir: str = "ml_platform/models/galleries/live_gallery",
        ...
        if encryptor is not None:
            ...
            from app.security_layer.biometric_encryption import BiometricEncryptor, ConfigurationError
