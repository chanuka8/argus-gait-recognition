...
from app.intelligence.evidence.operational_embedding_collector import OperationalEmbeddingCollector
from app.intelligence.fusion.learned_fusion import LearnedLogisticFusion
from app.intelligence.learning.continual_learning_audit_trail import ContinualLearningAuditTrail
from app.intelligence.learning.continual_learning_evaluator import ContinualLearningEvaluator
...
class BackgroundLearningWorker:
    def __init__(
        ...
        candidate_artifacts_dir: str = "ml_platform/models/model_store/candidates",
        ...
        from app.intelligence.learning.longitudinal_accuracy_evaluator import LongitudinalAccuracyEvaluator
