...
Pipeline Feature Embeddings → `app/intelligence/open_set_recognizer.py` & `app/intelligence/dual_modal_fusion.py` → `app/intelligence/decision_engine.py` → `app/intelligence/missing_person_workflow.py` → Alert / Security Output.
