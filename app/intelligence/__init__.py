...
try:
    from app.intelligence.learning.camera_topology_learner import CameraTopologyLearner, LearnedEdgeStats
except ImportError:
...
try:
    from app.intelligence.decision.confidence_scorer import ConfidenceScorer
except ImportError:
...
try:
    from app.intelligence.crowd.crowd_intelligence_system import CrowdIntelligenceEvaluation, CrowdIntelligenceSystem
except ImportError:
    CrowdIntelligenceEvaluation = None
    CrowdIntelligenceSystem = None

try:
    from app.intelligence.crowd.crowd_occlusion_analyzer import CrowdOcclusionAnalyzer, FrameCrowdAnalysis
except ImportError:
...
try:
    from app.intelligence.fusion.fusion_weights import DynamicFusionWeights
except ImportError:
    DynamicFusionWeights = None

try:
    from app.intelligence.evidence.missing_person_workflow import (
...
try:
    from app.intelligence.validation.open_set_recognizer import OpenSetDecisionResult, OpenSetRecognizer, OpenSetState
except ImportError:
...
try:
    from app.intelligence.validation.quality_assessment import QualityAssessment
except ImportError:
    QualityAssessment = None

try:
    from app.intelligence.decision.recognition_deferral_engine import (
        DeferralResult,
...
try:
    from app.intelligence.fusion.score_normalizer import ScoreNormalizer
except ImportError:
    ScoreNormalizer = None

try:
    from app.intelligence.tracking.track_recovery_manager import LostTrackRecord, TrackRecoveryManager
except ImportError:
    LostTrackRecord = None
    TrackRecoveryManager = None

try:
    from app.intelligence.decision.candidate_validator import CandidateValidator, ValidationGateResult
except ImportError:
    CandidateValidator = None
    ValidationGateResult = None

try:
    from app.intelligence.learning.drift_detector import DriftDetector, DriftReport
except ImportError:
    DriftDetector = None
    DriftReport = None
...
try:
    from app.intelligence.fusion.score_calibrator import ScoreCalibrator
except ImportError:
    ScoreCalibrator = None

try:
    from app.intelligence.decision.confusion_detector import ConfusionDetector
except ImportError:
...
try:
    from app.intelligence.fusion.learned_fusion import LearnedFusion
except ImportError:
    LearnedFusion = None

try:
    from app.intelligence.fusion.fusion_diagnostics import FusionDiagnostics
except ImportError:
