...
from app.pipeline.detection import PersonDetector
from app.pipeline.gei import StreamGEIBuilder
from app.pipeline.silhouette import SilhouetteExtractor
from app.pipeline.tracking import PersonTracker
...
class ArgusService:
    ...
    def _build_pipeline(self):
        ...
        pipeline = LiveRecognitionPipeline(
            ...
            gallery_dir=rec_cfg.get("gallery_dir", "ml_platform/models/galleries/live_gallery"),
        )
