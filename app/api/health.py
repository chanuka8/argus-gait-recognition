...
def health_degraded():
    ...
    if _runtime is not None:
        ...
        from app.streaming.production_runtime import CameraState
...
def health_hardware():
    from app.streaming.deployment_readiness import HardwareCapabilityDetector
...
def health_models():
    from app.streaming.deployment_readiness import ModelProfileRegistry
