...
def docs_check(args=None) -> int:
    ...
    if docs_dir.exists() and docs_dir.is_dir():
        ...
        required_docs = [
            ...
            "gallery_pipeline.md",
            "evaluation.md",
            "open_set_evaluation.md",
            "cross_view_evaluation.md",
            "benchmark.md",
            "live_recognition.md",
            "video_recognition.md",
            "multi_camera.md",
            "security_layer.md",
            "deployment.md",
        ...
        for doc in required_docs:
            ...
            if doc_path.exists():
                print(f"  [OK] Verified: docs/{doc}")
            else:
                print(f"  [ERROR] Missing: docs/{doc}")
                missing = True
    else:
        print("[ERROR] Missing: docs/ folder")
        missing = True
